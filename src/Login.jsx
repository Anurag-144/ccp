...
const LOGIN_CSS = `
  ...
  .auth-btn:hover  { filter: brightness(1.07); transform: translateY(-1px); box-shadow: 0 6px 22px rgba(0,180,216,.4); }
  ...
  .pw-toggle {
    ...
    font-size: 16px;
    padding: 2px;
    margin-top: -9px; /* account for mb on input */
    line-height: 1;
  }
`;
